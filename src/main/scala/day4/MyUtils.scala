...
object MyUtils {
    ...
    def data2MySQL(it: Iterator[(String, Int)]): Unit = {
        ...
        //先获得一个JDBC连接
        val conn: Connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/ssm?characterEncoding=UTF-8", "root", "smallming")
    ...
    def main(args: Array[String]): Unit = {
        ...
        //数据是在内存中
        val rules: Array[(Long, Long, String)] = readRules("D:\\ip\\ip.txt")


        //将ip地址转换成十进制
        val ipNum: Long = ipZLong("114.215.43.42")
